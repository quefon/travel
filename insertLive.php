...
<body>
	...
	<div id="body">
		<div class="one"><span>新增住資料</span></div>
		<div class="form">
		<form name="live" action="insertLiveAction.php" method="GET">
			<form action="uploadH.php" method="post" enctype="multipart/form-data" target="frame_upload">
			圖片：<br><input style="width:450px;" type="file" name="file" id="file" /><br><input type="submit" name="submit" value="確定上傳圖片" />
		</form>
		<iframe src="./uploadH.php" style="display:none;" id="frame_upload" name="frame_upload"></iframe> 
			...
			價格最高：<input type="text" name="max" required><br>
			價格最低：<input type="text" name="mix" required><br>
